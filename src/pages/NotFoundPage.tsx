...
export function NotFoundPage() {
  ...
  const motion = !prefersReducedMotion && level !== "static";

  return (
    <AppShell>
      <PageMeta title="Page Not Found | Gabriele Viganò" description="The requested page is not available." path="/404" />
      <main id="main-content" className="relative mx-auto flex min-h-[100dvh] max-w-7xl flex-col px-5 py-5 sm:px-8 sm:py-7 lg:px-10">
        <header className="relative z-10 flex items-center justify-between border-b border-white/[0.09] pb-4 sm:pb-5">
        ...
        <section className="relative flex flex-1 items-center py-16 sm:py-20" aria-labelledby="not-found-title">
          ...
          <m.div
            aria-hidden
            className="pointer-events-none absolute right-[-0.06em] top-1/2 -translate-y-1/2 select-none font-mono text-[clamp(11rem,39vw,34rem)] font-bold leading-none tracking-[-0.13em] text-white/[0.035]"
          ...
          >
            ...
            <div className="mt-14 max-w-2xl border-y border-white/[0.08] py-4 font-mono text-[10px] uppercase tracking-[0.12em] text-zinc-500 sm:flex sm:items-center sm:justify-between">
        ...
        <footer className="relative z-10 flex flex-wrap justify-between gap-3 border-t border-white/[0.09] pt-4 font-mono text-[9px] uppercase tracking-[0.15em] text-zinc-600 sm:pt-5">
