...
export const site = {
  ...
  description: "Computer Engineering student at Politecnico di Milano. I run my own self-hosted infrastructure, and product and QA for a student network of 500+ group chats.",
  socialImage: {
