...
export const notes: NoteItem[] = [
  {
    ...
    body: [
      ...
      "Running events with up to 1,000+ attendees taught me one thing: good operations are not loud; they are invisible when done right.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "I use layered protection: local redundancy, recoverable workloads, and encrypted cloud backup.",
