/**
 * ReactBits `BorderGlow` (MIT + Commons Clause), vendored as published.
 * https://reactbits.dev/components/border-glow
 *
 * Kept as upstream wrote it — mesh-gradient border under a cursor-tracked
 * conic mask, the soft-light fill near the edges, the layered outer glow and
 * the one-shot sweep. The only edits are a named export and default colours
