      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-5 pb-10 sm:px-8 lg:grid-cols-[1.12fr_0.88fr] lg:items-center lg:gap-16 lg:px-10">
        <div className="relative z-10">
          ...
          <m.div
            ...
            className="mt-7"
          >
            <p data-hero-intro className="max-w-xl text-xl font-medium leading-snug tracking-[-0.02em] text-zinc-300 sm:text-2xl">I turn complex projects into products people can use and teams can run.</p>
